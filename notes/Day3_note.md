...
/// Shell ของ Bottom Navigation 5 แท็บ (ใช้ StatefulShellRoute.indexedStack)
///
/// แต่ละแท็บมี Navigation Stack แยกของตัวเอง — เข้าไปดูรายละเอียดในแท็บหนึ่ง
/// แล้วสลับแท็บไปมา หน้าเดิมยังอยู่ (จุดเด่นของ StatefulShellRoute)
class HomeShell extends StatelessWidget {
  final StatefulNavigationShell navigationShell;
  const HomeShell({super.key, required this.navigationShell});
        ...
        child: SafeArea(
          child: SizedBox(
            ...
            child: Row(
              ...
              children: [
                _navItem(HugeIcons.strokeRoundedHome03, l.navHome, 0, i),
                _navItem(HugeIcons.strokeRoundedShield01, l.navPolicies, 1, i),
                _navItem(HugeIcons.strokeRoundedFile01, l.claimsTitle, 2, i),
                _navItem(HugeIcons.strokeRoundedCreditCard, l.paymentsPageTitle, 3, i),
                _navItem(HugeIcons.strokeRoundedUser, l.navProfile, 4, i),
              ],
            ),
          ),
        ),
  ...
  Widget _navItem(AppIconData icon, String label, int index, int currentIndex) {
